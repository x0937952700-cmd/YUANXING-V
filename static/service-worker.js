/* 沅興木業 PWA Service Worker - fix59-material-summary-warehouse-slots */
const YX_PWA_VERSION='fix59-material-summary-warehouse-slots';
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname==='/'||url.pathname.endsWith('.html')||url.pathname.startsWith('/customers')||url.pathname.startsWith('/orders')||url.pathname.startsWith('/master')||url.pathname.startsWith('/inventory')||url.pathname.startsWith('/ship')){event.respondWith(fetch(req,{cache:'no-store'}));return;}
