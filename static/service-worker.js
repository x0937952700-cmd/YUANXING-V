/* 沅興木業 PWA Service Worker - html-lock-repair-v3 */
const YX_PWA_VERSION='html-lock-repair-v3';
const STATIC_CACHE=`yuanxing-pwa-static-${YX_PWA_VERSION}`;
const PRECACHE_ASSETS=[
  '/static/manifest.webmanifest','/static/favicon.png',
  '/static/style.css?v=html-lock-repair-v3',
  '/static/yx_modules/final_mother_lock.css?v=html-lock-repair-v3',
  '/static/yx_modules/ornate_label_hardlock.css?v=html-lock-repair-v3',
  '/static/yx_modules/home_background_hardlock.css?v=html-lock-repair-v3',
  '/static/yx_assets/home_cloud_background.jpg?v=html-lock-repair-v3',
  '/static/pwa.js?v=html-lock-repair-v3',
  '/static/yx_modules/core_hardlock.js?v=html-lock-repair-v3',
  '/static/yx_modules/ornate_label_hardlock.js?v=html-lock-repair-v3',
  '/static/yx_modules/quantity_rule_hardlock.js?v=html-lock-repair-v3',
  '/static/yx_modules/product_sort_hardlock.js?v=html-lock-repair-v3',
  '/static/yx_modules/product_actions_hardlock.js?v=html-lock-repair-v3',
  '/static/yx_modules/customer_regions_hardlock.js?v=html-lock-repair-v3',
  '/static/yx_modules/warehouse_hardlock.js?v=html-lock-repair-v3',
  '/static/yx_modules/today_changes_hardlock.js?v=html-lock-repair-v3',
  '/static/yx_modules/settings_manual.js?v=html-lock-repair-v3',
  '/static/yx_modules/ship_single_lock.js?v=html-lock-repair-v3',
  '/static/yx_modules/html_direct_master_lock.js?v=html-lock-repair-v3',
