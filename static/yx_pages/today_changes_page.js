...
(function(){
  ...
  async function loadTodayChanges112(opts={}){
    ...
    const cacheKey = 'today_changes_light_v332';
  ...
  function install(){
    ...
    if (!state.shipRefreshBound) {
      ...
      const refreshTodayV214 = ()=>{
        try{
          ['today_changes_light_v332','today_changes_light_v307','today_changes_light_v287','today_changes_light_v282','today_changes_light_v252','today_changes_light_v215','today_changes_light_v210','today_changes_light_v208','today_changes_light_v207','today_changes_light_v198','today_changes_v215','today_changes_v210','today_changes_v208','today_changes_v207','today_changes_v198'].forEach(k=>window.YX?.cache?.remove?.(k));
        }catch(_e){}
