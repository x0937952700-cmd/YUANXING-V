...
/* 沅興木業 FULL MASTER main REAL LOADED COMPLETE - page_todos_master_main */
(function(){ window.__YX_FULL_MASTER_main_PAGE__='page_todos_master_main'; })();
...
(function(){
  ...
  const assign = (name, fn) => {
    if (YX && typeof YX.safeExpose === 'function' && typeof YX.mark === 'function') return YX.safeExpose(name, YX.mark(fn, `v20_${name}`), {allowReplace:true});
    window[name] = fn;
    return fn;
  };
