/* 沅興木業 FIX119 core hard-lock registry
   目的：把功能拆成獨立模組，再由 master_integrator 統一安裝，避免舊 FIX 函式覆蓋新版。 */
(function(){
  'use strict';
  if (window.YXHardLock && window.YXHardLock.version === 'fix119-customer-master-stable') return;
  ...
  window.YXHardLock = {
    version: 'fix119-customer-master-stable',
