...
(function(){
  ...
  function install(){
    ...
    try { document.dispatchEvent(new CustomEvent('yx:master-installed', {detail:{module:m, version:'fix134-stability-master-hardlock'}})); } catch(_e) {}
  }

  window.__YX_MASTER_REINSTALL__ = install;
  window.YX_MASTER_BRIDGE = Object.freeze({version:'fix134-stability-master-hardlock', install});
