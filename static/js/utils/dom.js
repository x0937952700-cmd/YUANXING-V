...
export function pageShell(title, inner, actions = '') {
  return `<section class="page"><div class="page-head"><div class="page-title">${esc(title)}</div><div class="page-actions"><button class="secondary" data-route="home">返回首頁</button>${actions}</div></div>${inner}</section>`;
}
