...
function renderCustomers(customers) {
  ...
  return ['北區','中區','南區'].map(r => `<div class="region-col"><div class="region-title">${r}</div>${customers.filter(c=>c.region===r).map(c=>customerCard(c,active)).join('') || '<div class="empty">目前沒有客戶</div>'}</div>`).join('');
}
...
export async function renderOrders(app) {
  ...
  app.innerHTML = pageShell('訂單', `<div class="card top-input-panel">
    <form id="addOrder" class="form-grid">
