...
if '119-v517_full_checklist_alignment_pack27' not in app:
...
if 'yuanxing-v517-static-css-icons' not in sw:
...
if '119-v517_full_checklist_alignment_pack27' not in manifest:
    fail.append('manifest start/id version is not v507')

data=read('static/yx_data_store.js')
for token in ['installApiBridge','installFetchBridge','localResponseForApi','getTodayWithUnplaced','today-changes\\/(count|badge)','filterAvailableAgainstWarehouse','v517-full-checklist-alignment-pack27']:
...
for token in ['applyMutation','installApi','installFetch','reduceAfterShip','appendTodayLocal','v517-full-checklist-alignment-pack27']:
    if token not in mut:
...
for token in ['v517-full-checklist-alignment-pack27','yx_warehouse_cache_v517-full-checklist-alignment-pack27','yx_warehouse_available_cache_v517-full-checklist-alignment-pack27']:
