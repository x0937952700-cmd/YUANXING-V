...
fail=[]
warn=[]
VERSION_APP='V119-V517-FULL-CHECKLIST-ALIGNMENT-PACK27'
VERSION_STATIC='119-v517_full_checklist_alignment_pack27'
VERSION_JS='v517-full-checklist-alignment-pack27'
...
for token in [VERSION_JS, 'yxRawFetch:true', 'sync_full=1', 'readCachedPayload', 'writeCachedPayload', 'yx_warehouse_cache_v517-full-checklist-alignment-pack27', 'yx_warehouse_available_cache_v517-full-checklist-alignment-pack27']:
...
has(sw, 'yuanxing-v517-static-css-icons', 'service-worker cache version')
...
has(manifest, '119-v517_full_checklist_alignment_pack27', 'manifest version')
