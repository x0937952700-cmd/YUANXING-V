...
for token in ['V119-V517-FULL-CHECKLIST-ALIGNMENT-PACK27','/api/health/release-readiness','regression_guard_rules','today_count_badge_same_source','warehouse_timeout_must_not_clear_local_rows','shipping_preview_must_render_feedback','customer_counts_rows_authoritative']:
    if token not in app:
