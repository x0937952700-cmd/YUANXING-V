...
checks={
    'app version V515':'V119-V517-FULL-CHECKLIST-ALIGNMENT-PACK27' in app,
    'static version V515':'119-v517_full_checklist_alignment_pack27' in app,
    'schema version V515':'v517-full-checklist-alignment-pack27' in app,
    ...
    'audit marker':'V517_FULL_CHECKLIST_ALIGNMENT_PACK25' in Path(__file__).read_text(encoding='utf-8'),
}
