...
add('version_bumped', 'v517-full-checklist-alignment-pack27' in app_src and 'v517-full-checklist-alignment-pack27' in warehouse_js, 'Static/API versions must be bumped')
