...
add('warehouse available light cache only', 'v517_fast_diag' in app and 'diagnostics light mode must never run the full unplaced calculator' in app)
add('current version false positive filter', 'v517_static_requirement_resolved' in app and 'V517_FULL_CHECKLIST_ALIGNMENT' in diag)
...
add('static master/action audits do not create red issues', 'v517_static_audit_resolved' in app and 'issues = []' in app)
failed=[n for n,ok in checks if not ok]
print('V517 diagnostic zero red audit')
