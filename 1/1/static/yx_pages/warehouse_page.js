...
(function(){
  ...
  const CACHE_VERSION = 'v342-status-unviewed-filter';
  ...
  function saveCellPayload(z,c,s,items,note){ return {operation_id:yxOperationId('warehouse-cell-save'),zone:clean(z).toUpperCase(),column_index:Number(c),slot_type:'direct',slot_number:Number(s),items:sanitizeCellItemsForSave(items||[]),note:note||'',client_stability:'v342-status-unviewed-filter'}; }
  ...
  async function moveCellContents(from,to){
    ...
    try{
      ...
      queuedWarehouseMovePost({
        ...
        client_stability:'v342-status-unviewed-filter',
  ...
  async function batchInsertWarehouseCells(z,c,s){
    ...
    queuedWarehousePost('/api/warehouse/batch-add-slots',{operation_id:yxOperationId('warehouse-batch-add-slots'),client_stability:'v342-status-unviewed-filter',zone:z,column_index:c,insert_after:s,count,slot_type:'direct'}, (d, token)=>{
  ...
  async function insertWarehouseCell(z,c,s){
    ...
    const token=beginColumnOp(z,c);
    state.lastGoodColumns.set(token.key, columnBefore);
    queuedWarehousePost('/api/warehouse/add-slot',{operation_id:yxOperationId('warehouse-add-slot'),client_stability:'v342-status-unviewed-filter',zone:z,column_index:c,insert_after:s,slot_type:'direct'}, (d, token)=>{
  ...
  async function deleteWarehouseCell(z,c,s){
    ...
    const token=beginColumnOp(z,c);
    state.lastGoodColumns.set(token.key, columnBefore);
    queuedWarehousePost('/api/warehouse/remove-slot',{operation_id:yxOperationId('warehouse-remove-slot'),client_stability:'v342-status-unviewed-filter',zone:z,column_index:c,slot_number:s,slot_type:'direct'}, (d, token)=>{
  ...
  async function returnWarehouseCell(z,c,s){
    ...
    const token=beginColumnOp(z,c);
    state.lastGoodColumns.set(token.key, columnBefore);
    queuedWarehousePost('/api/warehouse/return-unplaced',{operation_id:yxOperationId('warehouse-return-unplaced'),client_stability:'v342-status-unviewed-filter',zone:z,column_index:c,slot_number:s}, async (d, token)=>{
      applyWarehouseResponse(d,z,c, token);
  ...
  window.YXFinalWarehouse={version:'v342-status-unviewed-filter',render:renderWarehouse, openWarehouseModal, saveWarehouseCell, jumpProductToWarehouse, applyTargetedRetryRefresh};
