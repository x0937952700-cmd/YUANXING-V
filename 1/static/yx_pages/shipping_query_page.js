...
/* V332: open shipping query from operation status card shortcut. No renderer/interval/observer. */
(function(){
  'use strict';
  if(window.__YX_V332_SHIPPING_QUERY_SHORTCUT__) return;
  window.__YX_V332_SHIPPING_QUERY_SHORTCUT__=true;
  ...
  function readIntent(){ try{ let raw=localStorage.getItem('yx_status_open_shipping_query_v332'); let key='yx_status_open_shipping_query_v332'; if(!raw){ raw=localStorage.getItem('yx_status_open_shipping_query_v327'); key='yx_status_open_shipping_query_v327'; } if(!raw) return null; const d=JSON.parse(raw||'{}'); localStorage.removeItem(key); return d&&typeof d==='object'?d:null; }catch(_e){ return null; } }
