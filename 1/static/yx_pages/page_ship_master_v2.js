...
(function(){
  ...
  function syncHiddenSelect(){const select=$('ship-customer-item-select');if(!select)return;select.hidden=true;select.setAttribute('hidden','hidden');select.setAttribute('aria-hidden','true');select.innerHTML='<option value="">商品標籤清單已顯示在下方</option>';}
