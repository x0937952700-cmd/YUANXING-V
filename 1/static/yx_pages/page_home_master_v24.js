/* 沅興木業 FULL MASTER V24 REAL LOADED FINAL AUDIT - page_home_master_v24 */
(function(){ window.__YX_FULL_MASTER_V24_PAGE__='page_home_master_v24'; })();
...
/* ===== V26 HOME REAL LOADED HTML/JS LOCK: home logout button wired in actual loaded page_home_master_v24.js ===== */
(function(){
  'use strict';
  async function api(url,opt={}){
    const headers={'Content-Type':'application/json',...(opt.headers||{})};
