/* 沅興木業 FULL MASTER V52 PRODUCTS / SHIP / WAREHOUSE WRITEBACK - page_warehouse_master_v52 */
...
(function(){
  ...
  function updateNotes(){
    for(const z of zones){ const n=$(z==='A'?'zone-A-count-note':'zone-B-count-note'); if(n) n.textContent='6 欄｜根本樣式｜動態格數'; }
  }
