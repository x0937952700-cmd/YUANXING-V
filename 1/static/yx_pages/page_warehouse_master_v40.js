/* 沅興木業 FULL MASTER V40 WAREHOUSE REAL LOADED WRITEBACK - page_warehouse_master_v40 */
(function(){ window.__YX_FULL_MASTER_V40_PAGE__='page_warehouse_master_v40'; })();
...
(function(){
  'use strict';
  if (window.YXHardLock && window.YXHardLock.version === 'full-master-v40-warehouse-real-loaded-html-js-css-writeback') return;
  ...
  window.YXHardLock = {
    version: 'full-master-v40-warehouse-real-loaded-html-js-css-writeback',
...
(function(){
  ...
  function install(){ if(!isWarehouse()) return; document.documentElement.dataset.yxWarehouseSingleHtmlDataJs='true'; document.documentElement.dataset.yxWarehouseV40Fix='stable-batch-key-location-search-api-normalize'; document.documentElement.dataset.yxV40WarehouseWriteback='locked'; bindGlobal(); bindSlots(); setWarehouseZone(localStorage.getItem('warehouseActiveZone')||'A',false); renderWarehouse(true); }
