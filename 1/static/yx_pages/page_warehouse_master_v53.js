/* 沅興木業 FULL MASTER V53 PRODUCTS / SHIP / WAREHOUSE FIXED20 WRITEBACK - page_warehouse_master_v53 */
(function(){ window.__YX_FULL_MASTER_V53_PAGE__='page_warehouse_master_v53'; })();
...
(function(){
  ...
  function install(){ if(!isWarehouse()) return; document.documentElement.dataset.yxWarehouseSingleHtmlDataJs='true'; document.documentElement.dataset.yxWarehouseV42Fix='pending-search-modal-safe'; document.documentElement.dataset.yxV53WarehouseFixed20='locked'; document.documentElement.dataset.yxV42ShipWarehouseWriteback='locked'; bindGlobal(); bindSlots(); setWarehouseZone(localStorage.getItem('warehouseActiveZone')||'A',false); renderWarehouse(true).then(applyPendingWarehouseSearch).catch(()=>{}); }
...
(function(){
  ...
  try{document.documentElement.dataset.yxV53WarehouseFixed20='locked';}catch(_e){}
