/* 沅興木業 FULL MASTER V32 REAL LOADED WRITEBACK - page_today_changes_master_v32 */
(function(){ window.__YX_FULL_MASTER_V32_PAGE__='page_today_changes_master_v32'; })();
...
(function(){
  ...
  function lockGlobals(){
    ...
    if (window.YX_MASTER) {
      try { window.YX_MASTER = Object.freeze({...window.YX_MASTER, version:'full-master-v32-real-loaded-html-js-css-writeback', loadTodayChanges:fn}); } catch(_e) {}
    }
  }
  function install(){
    if (!isToday()) return;
...
/* V27 TODAY UNPLACED FILTER LOCK: HTML has initial unplaced chip and JS now persists data-today-filter="unplaced". */
