(() => {
  const PWA_VERSION = 'full-master-v81_from_v78_safe_warehouse_batch_header_fixed';
  ...
  if('serviceWorker' in navigator){
    window.addEventListener('load',()=>{
      window.__YX_PWA_VERSION__='full-master-v81_from_v78_safe_warehouse_batch_header_fixed';
