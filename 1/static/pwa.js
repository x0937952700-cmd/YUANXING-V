(() => {
  const PWA_VERSION = 'full-master-v82_from_v78_safe_warehouse_20_batch_header_fixed';
  ...
  if('serviceWorker' in navigator){
    window.addEventListener('load',()=>{
      window.__YX_PWA_VERSION__='full-master-v82_from_v78_safe_warehouse_20_batch_header_fixed';
