(() => {
  const PWA_VERSION = 'full-master-v83_safe_warehouse_20_push_undo_batch_fixed';
  ...
  if('serviceWorker' in navigator){
    window.addEventListener('load',()=>{
      window.__YX_PWA_VERSION__='full-master-v83_safe_warehouse_20_push_undo_batch_fixed';
