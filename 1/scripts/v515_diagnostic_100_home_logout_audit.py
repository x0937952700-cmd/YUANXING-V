...
add('warehouse available light cache only', 'v515_fast_diag' in app and 'diagnostics light mode must never run the full unplaced calculator' in app)
add('current version false positive filter', 'v515_evidence_resolved' in app and 'V515_DIAGNOSTIC_100_HOME_LOGOUT_REMOVAL' in diag)
failed=[n for n,ok in checks if not ok]
print('V515 diagnostic/home logout audit')
