...
for token in ['V119-V485-RESTORE-BUTTONS-REALTIME-SHIP-WH','regression_guard_rules','today_count_badge_same_source','warehouse_timeout_must_not_clear_local_rows','shipping_preview_must_render_feedback','customer_counts_rows_authoritative']:
    if token not in app:
