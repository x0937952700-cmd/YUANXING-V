...
for token in [VERSION_JS, 'yxRawFetch:true', 'sync_full=1', 'readCachedPayload', 'writeCachedPayload', 'yx_warehouse_cache_v481-deploy-regression-verify-pass18', 'yx_warehouse_available_cache_v481-deploy-regression-verify-pass18']:
...
has(sw, 'yuanxing-v481-static-css-icons', 'service-worker cache version')
...
has(manifest, '119-v481-deploy-regression-verify-pass18', 'manifest version')
