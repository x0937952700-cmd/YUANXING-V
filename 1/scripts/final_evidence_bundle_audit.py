...
checks={
 'app version V511':'V119-V514-POSTDEPLOY-EVIDENCE-COLLECTOR-PACK24' in app,
 'static version V511':'119-v514_postdeploy_evidence_collector_pack24' in app,
 'schema version V511':'v514-postdeploy-evidence-collector-pack24' in app,
 ...
 'postdeploy evidence script shipped':'V119-V514-POSTDEPLOY-EVIDENCE-COLLECTOR-PACK24' in post and '/api/health/final-evidence-bundle' in post,
 'predeploy includes evidence audit':'scripts/final_evidence_bundle_audit.py' in pre,
 'manifest bumped':'119-v514-postdeploy-evidence-collector-pack24' in manifest,
 'service worker bumped no API cache':'yuanxing-v514-static-css-icons' in sw and '/api/' in sw,
}
