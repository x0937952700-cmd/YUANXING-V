...
required_app=['V119-V515-DIAGNOSTIC-100-HOME-LOGOUT-REMOVAL-PACK25','119-v515_diagnostic_100_home_logout_removal_pack25','v515-diagnostic-100-home-logout-removal-pack25','/api/health/write-test-safety','def api_health_write_test_safety','_diag_v513_write_test_safety_audit']
...
for token in ['/api/health/write-test-safety','V119-V515-DIAGNOSTIC-100-HOME-LOGOUT-REMOVAL-PACK25']:
...
if 'V515_DIAGNOSTIC_100_HOME_LOGOUT_REMOVAL_PACK25' not in Path(__file__).read_text(encoding='utf-8'): fail.append('audit marker missing')
if fail:
