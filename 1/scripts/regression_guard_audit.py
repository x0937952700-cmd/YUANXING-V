...
for token in ['v520-final-ship-cache-align-pack30','patchDataStore','empty_overwrite_blocked','empty_response_rows_blocked','today_unplaced_guard','shipping_preview_guard','warehouse_timeout_guard','runSelfCheck','YXRegressionGuard']:
    if token not in rg:
