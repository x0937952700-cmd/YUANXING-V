...
required = {
    ...
    'templates/base.html': [VERSION, '__YX_MASTER_VERSION__', 'yxV28LoadedAudit', 'yxV32RealWriteback', 'yxV42ShipWarehouseWriteback', 'yxV44ProductSubmitWriteback', 'yxV48ProductsWriteback', 'yx-asset-error-banner', 'page_inventory_master_v48.js', 'page_orders_master_v48.js', 'page_master_order_master_v48.js', 'page_ship_master_v42.js', 'page_warehouse_master_v42.js'],
    ...
    'templates/module.html': ['warehouse-unplaced-list-inline', 'data-html-locked="warehouse-unplaced-inline-list"', 'ship-preview-panel', 'data-yx42-html-shell="ship-preview-real-loaded"', 'data-yx42-warehouse-html="real-loaded"', 'data-yx-v44-submit="real-loaded"', 'data-yx-v48-submit="real-loaded"', 'data-yx-v48-duplicate-panel="real-loaded"'],
    'static/style.css': ['V26 REAL LOADED HTML / JS / CSS AUDIT LOCK', 'V27 REAL LOADED HTML / JS / CSS AUDIT LOCK', 'V28 REAL LOADED HTML / JS / CSS AUDIT LOCK', 'V32 REAL LOADED HTML / JS / CSS WRITEBACK LOCK', 'V40 WAREHOUSE REAL LOADED HTML / JS / CSS WRITEBACK LOCK', 'V42 SHIP + WAREHOUSE REAL LOADED HTML / JS / CSS WRITEBACK LOCK', 'V44 PRODUCT SUBMIT REAL LOADED WRITEBACK', 'V48 products real-loaded HTML/JS/CSS writeback', 'V32 asset-load failure banner', '.home-logout-btn', 'yx27-shipping-query-bar', 'yx28-warehouse-unplaced-inline', '#ship-preview-panel', '#yx113-customer-actions'],
    ...
    'static/yx_pages/page_inventory_master_v48.js': ['YX113ProductActions', 'bulkDelete', 'rowActionsHTML', 'confirmDuplicateMerge', 'applySnapshotFromResponse', 'window.YX = window.YXHardLock', 'window.__YX_V48_PRODUCTS_FINAL_CAPTURE__'],
    ...
    'static/yx_pages/page_orders_master_v48.js': ['YX113ProductActions', 'bulkDelete', 'rowActionsHTML', 'confirmDuplicateMerge', 'refreshCustomerBoardsSafe', 'moveCustomer', 'applySnapshotFromResponse', 'window.YX = window.YXHardLock', 'window.__YX_V48_PRODUCTS_FINAL_CAPTURE__'],
    'static/yx_pages/page_master_order_master_v48.js': ['YX113ProductActions', 'bulkDelete', 'rowActionsHTML', 'confirmDuplicateMerge', 'refreshCustomerBoardsSafe', 'moveCustomer', 'applySnapshotFromResponse', 'window.YX = window.YXHardLock', 'window.__YX_V48_PRODUCTS_FINAL_CAPTURE__'],
}
...
print('v48 products real loaded html/js/css writeback smoke test OK')

for rel in ['static/yx_pages/page_inventory_master_v48.js','static/yx_pages/page_orders_master_v48.js','static/yx_pages/page_master_order_master_v48.js']:
