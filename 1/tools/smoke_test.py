...
VERSION = 'full-master-v49_warehouse_real_persist_ab_unassigned'
...
required = {
    ...
    'app.py': ['/api/warehouse/cell', '/api/warehouse/available-items', 'warehouse_item_exact_key', 'warehouse_customer_key', 'zone_summary', '格位沒有確實寫入資料庫'],
    'db.py': ['def warehouse_save_cell', 'ON CONFLICT(zone, column_index, slot_type, slot_number)', '_warehouse_exact_key'],
...
print('v49 warehouse persistence/ab-unassigned smoke test OK')
