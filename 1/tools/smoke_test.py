...
VERSION = 'full-master-v82_from_v78_safe_warehouse_20_batch_header_fixed'
...
required = {
    ...
    'db.py': ['def warehouse_add_slot', 'def warehouse_remove_slot', 'ensure_warehouse_default_20_v82', 'V82_FROM_V78_SAFE_WAREHOUSE_20_BATCH_HEADER_FIX', 'ON CONFLICT'],
    'static/yx_pages/page_warehouse_master_v22.js': ['V82：從 V78 重新修正', 'optimisticSlot', '後端會先安全補缺格再刪除空格'],
...
print('v82 from-v78 warehouse/materialize + batch header smoke test OK')
