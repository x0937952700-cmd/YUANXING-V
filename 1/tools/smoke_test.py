...
VERSION = 'full-master-v83_safe_warehouse_20_push_undo_batch_fixed'
...
required = {
    ...
    'db.py': ['def warehouse_add_slot', 'def warehouse_remove_slot', 'ensure_warehouse_default_20_v82', 'V83：每次讀取前安全補回', 'ON CONFLICT'],
...
print('v83 safe warehouse 20 + pushProductUndo + batch edit smoke test OK')
